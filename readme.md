...
- [**Purist Morrowind**](https://github.com/Sigourn/morrowind-improved/blob/master/mendingmw.md): a small guide for a (mostly) bug-free, stable, and purist Morrowind experience.
- [**Modded Morrowind**](https://github.com/Sigourn/morrowind-improved/blob/master/modlist.md): this guide aims to fix many issues with Morrowind as a whole, beyond simple bug fixes: improving the user interface, reinforcing the internal consistency of the game, quality of life visual, sound, and gameplay improvements, and providing a more balanced gameplay experience.
