...
My mod list uses a working mod installation order and plugin load order that guarantees conflicts will be kept to the bare minimum. You can download a package containing these in .txt form from here: [**Morrowind Improved June 11th**](https://www.mediafire.com/file/vsusvd9uyhhqf0l/Morrowind_Improved_June_11th.zip/file)
