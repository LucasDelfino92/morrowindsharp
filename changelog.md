...
- User Interface: re-added **Book Worm**.
- User Interface: moved **Character Creation Name Generator** to this section (it's no gameplay mod, but a new menu).
...
- Removed Internal Logic section.
...
- Moved all Internal Logic mods to the Gameplay section.
- Moved **The Publicans** to the Gameplay section.
...
**Internal logic**
- Removed [**Outlander Yourself**](https://www.nexusmods.com/morrowind/mods/45674) (not an oversight)
