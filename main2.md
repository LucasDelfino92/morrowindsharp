...
This guide is the second step in the installation of our modlist. Please make sure to follow the [**Setup**](setup.md) section before proceeding. For an abridged installation, intended for new users, see [**Nerevar Rising**](main.md).
