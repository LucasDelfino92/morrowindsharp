...
> ℹ️ The following section is taken verbatim from **VishVadeva**'s **The Midnight Ride** guide for Fallout 4, which explains in detail how to install mods using Mod Organizer 2. All credits go to him.
...
### Installation instructions:
- **Main files - Diligent Defenders v1.2**
...
### Installation instructions:
- **Main files - quest_skill_reward_fix**
...
### Installation instructions:
- **Main files - Accurate Tooltip Stats**
...
### Installation instructions:
- **Main files - Propylon Index Renamer**
...
### Installation instructions:
- **Main files - Subtle Smoke Main File**
...
### Installation instructions:
- **Main files - Properly Fitted Female Pants**
